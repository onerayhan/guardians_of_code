    ...
    return (
        <body className="bg-[#081730]">
            ...
            <div className="flex relative justify-center top-20">
                <h1 className="text-5xl text-white font-lalezar">There are 3 ways to add a song.</h1>
            </div>
            <div className="flex items-center justify-center min-h-screen bg-[#081730]">
                ...
                <div className="w-1/2 text-center flex flex-col items-center justify-center pr-32">
                    ...
                    {spoti_auth ?
                        <div>
                            ...
                            :
                        <VStack>
                            <Button isDisabled={true}>No Spotify Account Linked</Button>
                            <Button leftIcon={<FaSpotify />} onClick={handleSpotifyIntegration} textColor="black" colorScheme='green' variant='solid'>
                                Connect to Spotify
                            </Button>
                        </VStack>
                    }
                ...
                <div className="flex flex-col items-center justify-center h-full pl-14 pl-5">
                    <div className="flex flex-col items-center justify-center gap-y-4 mt-8">
                        <h1 className="text-white font-lalezar my-5 text-2xl">Option 3: Manually Enter Song Information</h1>
                        <Formik
                            initialValues={
                                {
                                    song_name: '',
                        ...
                        >
                            {({ errors, touched, isValid, isSubmitting }) => (
                                <Form className="flex flex-col items-center justify-center gap-y-4">
                                    ...
                                    <div className="relative">
                                        <Field as="select" name="recording_type" placeholder="Select Recording Type" className="w-[400px] h-12 text-center font-semibold text-black text-opacity-80 rounded-xl bg-white">
