    ...
    >
      <div className="wrapper bg-[#081730] flex items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
        ...
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          <span className="text-[#cccad5]">Experience The</span>{" "}
          <span>
            <b className="text-[#cccad5]">Best Music App</b>
          </span>
          <span className="text-[15px] text-[#525D6E]">
            Get recommendations, browse music, and discover your next favorite
            <br />
            Add your friends, get recommendations based on your friends’ tastes
          </span>
          {/* download ads */}
          <div>
